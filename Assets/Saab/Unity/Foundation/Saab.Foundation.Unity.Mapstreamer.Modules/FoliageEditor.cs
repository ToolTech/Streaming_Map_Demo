...
namespace Saab.Foundation.Unity.MapStreamer.Modules
{
    ...
    public class FoliageEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            foliage.Feature = (Feature)EditorGUILayout.EnumPopup("Feature", foliage.Feature);
            foliage.Biome = (FoliageBiome)EditorGUILayout.EnumFlagsField("Biome", foliage.Biome);
            foliage.Mesh = (Mesh)EditorGUILayout.ObjectField("Mesh", foliage.Mesh, typeof(Mesh));
            foliage.MeshMaterial = (Material)EditorGUILayout.ObjectField("Mesh Material", foliage.MeshMaterial, typeof(Material));
            ...
            if (foliage.MainTexture != null)
            {
                ...
                EditorGUI.DrawRect(new Rect(3 - 5 + PreviewSize * (foliage.Offset.x + 0.5f), HeightPos - 5 + PreviewSize * (1 - foliage.Offset.y), 10, 10), new Color(1, 0, 0, 0.5f));
