...
Shader "Terrain/DynamicTerrain/StarTree"
{
	Properties
	{
			...
			Pass
			{
				...
				void geom(point uint p[1] : TEXCOORD, inout TriangleStream<FramentInput> triStream)
				{
					...
					if (GemerateGeometry(p[0], grassPosition, displacement, displacementx, size, tilt, tiltx, bottomColor, topColor, uvDistortion, textureWaving, index))
					{
						...
						half4 a1 = half4(0, size.y / 2, 0, 0);
						half4 a2 = half4(0, size.y / 3, 0, 0);
						half4 a3 = half4(0, (size.y / 3) * 2, 0, 0);
						half4 a4 = half4(0, 0, 0, 0);
						half4 a5 = half4(0, size.y, 0, 0);
						half4 a6 = half4(0, size.y / 3, 0, 0);
						half4 a7 = half4(0, (size.y / 3) * 2, 0, 0);
						half4 a8 = half4(0, size.y / 2, 0, 0);

						half4 b1 = half4(0, size.y / 6, 0, 0);
						half4 b2 = half4(0, size.y / 3, 0, 0);
						half4 b3 = half4(0, (size.y / 2), 0, 0);
						half4 b4 = half4(0, size.y / 6, 0, 0);
						half4 b5 = half4(0, (size.y / 6) * 5, 0, 0);
						half4 b6 = half4(0, (size.y / 2), 0, 0);
						half4 b7 = half4(0, (size.y / 3) * 2, 0, 0);
						half4 b8 = half4(0, (size.y / 6) * 5, 0, 0);
						...
						if (tiltx <= 1 && tiltx >= -1)
						{
							...
							AppendVertex(triStream, grassPosition, -displacement + a1, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, -displacement / 3 + a2, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, -displacement / 3 + a3, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, a4, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, a5, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, displacement / 3 + a6, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, displacement / 3 + a7, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, displacement + a8, upNormal, fixed3(0.5, 0, index), topColor);

							triStream.RestartStrip();

							// second star

							AppendVertex(triStream, grassPosition, (-displacement / 3) * 2 + b1, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, b2, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, (-displacement / 3) + b3, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, (displacement / 3) * 2 + b4, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, (-displacement / 3) * 2 + b5, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, (displacement / 3) + b6, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, b7, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, (displacement / 3) * 2 + b8, upNormal, fixed3(0.5, 0, index), topColor);
						...
						if (tilt <= 1 && tilt >= -1)
						{
							...
							AppendVertex(triStream, grassPosition, -displacementx + a1, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, -displacementx / 3 + a2, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, -displacementx / 3 + a3, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, a4, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, a5, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, displacementx / 3 + a6, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, displacementx / 3 + a7, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, displacementx + a8, upNormal, fixed3(0.5, 0, index), topColor);

							triStream.RestartStrip();

							// second star

							AppendVertex(triStream, grassPosition, (-displacementx / 3) * 2 + b1, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, b2, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, (-displacementx / 3) + b3, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, (displacementx / 3) * 2 + b4, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, (-displacementx / 3) * 2 + b5, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, (displacementx / 3) + b6, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, b7, upNormal, fixed3(0.5, 0, index), topColor);
							AppendVertex(triStream, grassPosition, (displacementx / 3) * 2 + b8, upNormal, fixed3(0.5, 0, index), topColor);
